import { Fire, Player } from './GameObjects.js';
import { MovingGameObject } from './GameObjects.js';
...
export default class GameLogicService {
  ...
  fire(firingGameObject) {
    var fireGameObject = this.createGameObject(
      Fire,
  ...
  createGameObject(gameObjectClass, ...args) {
    var gameObject = new gameObjectClass(...args);
